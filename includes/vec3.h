...
// point3 is just an alias for vec3, but uesful for geometric clarity in the code.
using point3 = vec3;
...
// The random_unit_vector() function, version one.
...
// The random_on_hemisphere() function.
...
// Building the refraction function
